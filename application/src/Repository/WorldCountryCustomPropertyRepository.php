...
/**
 * @extends ServiceEntityRepository<WorldCountryCustomProperty>
 */
class WorldCountryCustomPropertyRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, WorldCountryCustomProperty::class);
    }
    ...
    public function getId(int $id = 1): array | object
    {
